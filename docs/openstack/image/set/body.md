...
=== "Header"
    ...
    X-Requestshook-Request-Id: 84ca9e8bfa9341f1abe0c1d40173354c
...
=== "Header"
    ...
    Content-Type: application/json
    Content-Length: 209
    X-Requestshook-Request-Id: ceb7e5b7b8e0484f84e5aa98af7875da
    X-Requestshook-Request-From: openstack
    ```
...
=== "Header"
    ...
    Content-Type: application/json
    Content-Length: 3952
    X-Subject-Token: gAAAAABjspozu5Cj729GHlHirSgwMJMF232wgMcUvtiA0IXHT4Yhy7ZKTSdr4Icgf162ipP2O1K2udSC2gfmPNitng7K-tBkYdhijtoiJK-LvfGtVRQU2zJXrgrUsTLmQ_kr7UCW0gu0wMgIWGmhGwB7WFXPIJDGLOxeHI4go2p10ttS_i_dgyk
    Vary: X-Auth-Token
    X-Requestshook-Request-Id: ceb7e5b7b8e0484f84e5aa98af7875da
    X-Requestshook-Request-From: openstack
    ```
...
=== "Body"
    ``` json title="201 CREATED /identity/v3/auth/tokens" linenums="1"
    {
      "token": {
        ...
        "audit_ids": [
          "oOuyx3T3S7iZOMwAtauk1g"
        ],
        "expires_at": "2023-01-02T11:47:47.000000Z",
        "issued_at": "2023-01-02T08:47:47.000000Z",
        "project": {
          "domain": {
            "id": "default",
            "name": "Default"
...
=== "Header"
    ...
    Accept-Encoding: gzip, deflate
    Accept: */*
    X-Auth-Token: gAAAAABjspozu5Cj729GHlHirSgwMJMF232wgMcUvtiA0IXHT4Yhy7ZKTSdr4Icgf162ipP2O1K2udSC2gfmPNitng7K-tBkYdhijtoiJK-LvfGtVRQU2zJXrgrUsTLmQ_kr7UCW0gu0wMgIWGmhGwB7WFXPIJDGLOxeHI4go2p10ttS_i_dgyk
    X-Requestshook-Request-Id: daa05f3b4b6f41d8a8b613038fb82a3c
    X-Requestshook-Request-From: openstack
...
=== "Header"
    ...
    X-Requestshook-Request-Id: 1a42805549204a6eac7770bfc895649e
...
=== "Header"
    ...
    Content-Length: 950
    Content-Type: application/json
    x-openstack-request-id: req-4aa20c74-0f4c-48ae-887d-e660798b948c
    X-Requestshook-Request-Id: daa05f3b4b6f41d8a8b613038fb82a3c
    X-Requestshook-Request-From: openstack
    ```
...
=== "Body"
    ``` json title="200 OK /v2/images/a42bfade-78ec-4c95-b7b4-272ba265072c" linenums="1"
    {
      ...
      "updated_at": "2023-01-02T08:45:43Z",
      "tags": [],
...
이미지 태그 설정은 `Update image`, `Add image tag` API에서 모두 가능하다.  
여기서는(`openstack-client`) `Update image` API를 사용하고 있다.  

=== "Header"
    ``` http title="PATCH /v2/images/a42bfade-78ec-4c95-b7b4-272ba265072c" linenums="1" hl_lines="6"
    Host: 127.0.0.1:60999
    User-Agent: openstacksdk/0.101.0 keystoneauth1/5.0.0 python-requests/2.28.1 CPython/3.8.10
    Accept-Encoding: gzip, deflate
    Accept: 
    ...
    X-Auth-Token: gAAAAABjspozu5Cj729GHlHirSgwMJMF232wgMcUvtiA0IXHT4Yhy7ZKTSdr4Icgf162ipP2O1K2udSC2gfmPNitng7K-tBkYdhijtoiJK-LvfGtVRQU2zJXrgrUsTLmQ_kr7UCW0gu0wMgIWGmhGwB7WFXPIJDGLOxeHI4go2p10ttS_i_dgyk
    X-Requestshook-Request-Id: 2a404c7c370447f8ba7f9d5d4f7d8c2a
    X-Requestshook-Request-From: openstack
    X-Forwarded-For: 182.161.114.101
    X-Forwarded-Host: 182.161.114.101
    X-Forwarded-Server: 127.0.0.1
...
=== "Body"
    ``` json title="PATCH /v2/images/a42bfade-78ec-4c95-b7b4-272ba265072c" linenums="1"
    [
      {
        "op": "add",
        "path": "/tags",
...
=== "Header"
    ...
    Content-Length: 958
    Content-Type: application/json
    x-openstack-request-id: req-8b493faf-d5e2-4c2c-bfb3-8cc095a9a08c
    X-Requestshook-Request-Id: 2a404c7c370447f8ba7f9d5d4f7d8c2a
    X-Requestshook-Request-From: openstack
    ```
